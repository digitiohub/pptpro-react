      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            ...
            <motion.div
              className="border border-gray-400 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-full py-2 px-6 text-sm font-medium mx-4"
        ...
        >
          {stats.map((stat, index) => (
            <React.Fragment key={stat.name}>
              ...
              >
                <motion.h3
                  className="text-3xl md:text-4xl lg:text-5xl font-bold text-yellow-500 mb-2"
                  style={{ transform: "translate3d(0, 0, 0)" }}
                  initial={{ opacity: 0.4 }}
              ...
              {index < stats.length - 1 && (
                <motion.div
                  className="hidden md:block self-stretch w-px bg-gray-300 dark:bg-gray-700 mx-6"
