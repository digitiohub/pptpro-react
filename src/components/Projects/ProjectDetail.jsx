        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ ...contentSpringTransition, delay: 0.1 }}
            >
            ...
            <motion.h1
              ...
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ ...contentSpringTransition, delay: 0.2 }}
            >
              {project.title}
            </motion.h1>
            ...
            <motion.div
              ...
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ ...contentSpringTransition, delay: 0.3 }}
            >
            ...
            {project.results && (
              <motion.div
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ ...contentSpringTransition, delay: 0.4 }}
              >
            ...
            {project.gallery && project.gallery.length > 0 && (
              <motion.div
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ ...contentSpringTransition, delay: 0.5 }}
              >
