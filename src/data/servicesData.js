...
// Also export a list of services for navigation or listing purposes
export const servicesList = [
  {
    slug: "corporate-presentation",
    title: "Corporate Presentation",
    shortDescription:
      "Strategic visual communication for business stakeholders",
    icon: "Building",
  },
  {
    slug: "video-presentation",
    title: "Video Presentation",
    shortDescription: "Dynamic motion graphics and animated storytelling",
    icon: "Film",
  },
  {
    slug: "presentation-training",
    title: "Presentation Training",
    shortDescription:
      "Master the art of impactful delivery and public speaking",
    icon: "Users",
  },
  {
    slug: "financial-modeling",
    title: "Financial Modeling",
    shortDescription: "Data-driven presentations for investors and executives",
    icon: "TrendingUp",
  },
];
